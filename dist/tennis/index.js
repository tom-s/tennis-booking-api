      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            executionTime = isWeekend ? date.getTime() - _common.MS_PER_HOUR * 6 : date.getTime() - _common.MS_PER_HOUR * 48;
                  ...
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      case 0:
                        ...
                        _context4.next = 3;
                        return (0, _scheduler.scheduleJob)(job.executionTime, job);
...
var canBookNow = function canBookNow(date) {
  ...
  var hoursDifference = (date.getTime() - now.getTime()) / _common.MS_PER_HOUR;
