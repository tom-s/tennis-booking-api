...
var formatEmail = exports.formatEmail = function formatEmail(data, template) {
  ...
  var replacements = [{
    ...
    'name': '%executionDate',
    'value': (0, _common.pad)(executionDate.getDate()) + '/' + (0, _common.pad)(executionDate.getMonth() + 1) + '/' + (0, _common.pad)(executionDate.getFullYear()) + ' at ' + (0, _common.pad)(executionDate.getHours()) + ':' + (0, _common.pad)(executionDate.getMinutes())
  }, {
    'name': '%court',
    'value': court
  }];
