...
var extractData = function extractData(history) {
  return history.reduce(function (memo, reply) {
...
var initRoutes = exports.initRoutes = function initRoutes(server) {
  server.route({
    ...
    path: '/tennis/book',
    handler: {
      async: function async(_ref, reply) {
        var _this = this;

        var payload = _ref.payload;
        return (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
          var replyHistory, _extractData, _extractData2, dateStr, court, date, booking;
